...
/**
 * Test for /api/v1/Donor/getMyVC/{PledgeId}
 */
Test('/api/v1/Donor/getMyVC/{PledgeId}', function (t) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Donor/getMyVC/{PledgeId}']['post']['responses']['200']['schema']);
