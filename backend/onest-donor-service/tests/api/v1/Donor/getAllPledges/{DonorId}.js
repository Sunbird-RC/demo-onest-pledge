...
/**
 * Test for /api/v1/Donor/getAllPledges/{DonorId}
 */
Test('/api/v1/Donor/getAllPledges/{DonorId}', function (t) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Donor/getAllPledges/{DonorId}']['post']['responses']['200']['schema']);
