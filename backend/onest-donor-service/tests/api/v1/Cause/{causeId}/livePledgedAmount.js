...
/**
 * Test for /api/v1/Cause/{causeId}/livePledgedAmount
 */
Test('/api/v1/Cause/{causeId}/livePledgedAmount', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/v1/Cause/{causeId}/livePledgedAmount']['get']['responses']['200']['schema']);
